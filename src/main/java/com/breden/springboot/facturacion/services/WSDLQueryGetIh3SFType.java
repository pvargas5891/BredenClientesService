...
public class WSDLQueryGetIh3SFType  implements java.io.Serializable {
    private com.breden.springboot.facturacion.common.TtContext[] dsSessionContext;

    private com.breden.springboot.facturacion.services.TtQueryType[] dsQuery;

    public WSDLQueryGetIh3SFType() {
    }

    public WSDLQueryGetIh3SFType(
           com.breden.springboot.facturacion.common.TtContext[] dsSessionContext,
           com.breden.springboot.facturacion.services.TtQueryType[] dsQuery) {
    ...
    /**
     * Gets the dsSessionContext value for this WSDLQueryGetIh3SFType.
     * 
    ...
    /**
     * Sets the dsSessionContext value for this WSDLQueryGetIh3SFType.
     * 
    ...
    /**
     * Gets the dsQuery value for this WSDLQueryGetIh3SFType.
     * 
     * @return dsQuery
     */
    public com.breden.springboot.facturacion.services.TtQueryType[] getDsQuery() {
        return dsQuery;
    }


    /**
     * Sets the dsQuery value for this WSDLQueryGetIh3SFType.
     * 
     * @param dsQuery
     */
    public void setDsQuery(com.breden.springboot.facturacion.services.TtQueryType[] dsQuery) {
        this.dsQuery = dsQuery;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSDLQueryGetIh3SFType)) return false;
        WSDLQueryGetIh3SFType other = (WSDLQueryGetIh3SFType) obj;
    ...
    public synchronized int hashCode() {
        ...
        if (getDsQuery() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getDsQuery());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSDLQueryGetIh3SFType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLQueryGetIh3SFType"));
