...
public class SoapBindingStub extends org.apache.axis.client.Stub implements com.breden.springboot.facturacion.services.QdocWebService_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReferenceParameters"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReferenceParametersType"), com.breden.springboot.facturacion.addressing.ReferenceParametersType.class, true, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReplyTo"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReplyToType"), com.breden.springboot.facturacion.addressing.ReplyToType.class, true, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "queryGetIh3SF"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLQueryGetIh3SFType"), com.breden.springboot.facturacion.services.WSDLQueryGetIh3SFType.class, false, false);
        oper.addParameter(param);
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "queryGetIh3SFResponse"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLQueryGetIh3SFResponseType"), com.breden.springboot.facturacion.services.WSDLQueryGetIh3SFResponseType.class, false, false);
        oper.addParameter(param);
    ...
    public SoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.facturacion.addressing.ReferenceParametersType.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.facturacion.addressing.ReplyToType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.facturacion.common.Temp_err_msg[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.facturacion.common.TtContext[].class;
            cachedSerClasses.add(cls);
            ...
            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", ">dsHistoria");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.facturacion.services.TtidhhistResponseType[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "TtidhhistResponseType");
            qName2 = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "ttidhhist");
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());

            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", ">dsQuery");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.facturacion.services.TtQueryType[].class;
            cachedSerClasses.add(cls);
            ...
            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "TtidhhistdetResponseType");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.facturacion.services.TtidhhistdetResponseType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLQueryGetIh3SFResponseType");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.facturacion.services.WSDLQueryGetIh3SFResponseType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLQueryGetIh3SFType");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.facturacion.services.WSDLQueryGetIh3SFType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {action.value, to.value, messageID.value, referenceParameters, replyTo, body});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                body2.value = (com.breden.springboot.facturacion.services.WSDLQueryGetIh3SFResponseType) _output.get(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "queryGetIh3SFResponse"));
            } catch (java.lang.Exception _exception) {
                body2.value = (com.breden.springboot.facturacion.services.WSDLQueryGetIh3SFResponseType) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "queryGetIh3SFResponse")), com.breden.springboot.facturacion.services.WSDLQueryGetIh3SFResponseType.class);
            }
        }
