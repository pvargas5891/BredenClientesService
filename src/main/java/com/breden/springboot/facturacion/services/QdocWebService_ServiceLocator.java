...
public class QdocWebService_ServiceLocator extends org.apache.axis.client.Service implements com.breden.springboot.facturacion.services.QdocWebService_Service {
    ...
    private java.lang.String QdocWebService_address = "http://QAD-001:8080/qxiprod/services/QdocWebService";
    ...
    public com.breden.springboot.facturacion.services.QdocWebService_PortType getQdocWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.breden.springboot.facturacion.services.SoapBindingStub _stub = new com.breden.springboot.facturacion.services.SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.breden.springboot.facturacion.services.QdocWebService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.breden.springboot.facturacion.services.SoapBindingStub _stub = new com.breden.springboot.facturacion.services.SoapBindingStub(new java.net.URL(QdocWebService_address), this);
                _stub.setPortName(getQdocWebServiceWSDDServiceName());
                return _stub;
            }
        }
