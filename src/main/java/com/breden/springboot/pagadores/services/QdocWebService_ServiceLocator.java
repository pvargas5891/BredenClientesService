...
public class QdocWebService_ServiceLocator extends org.apache.axis.client.Service implements com.breden.springboot.pagadores.services.QdocWebService_Service {
    ...
    public com.breden.springboot.pagadores.services.QdocWebService_PortType getQdocWebService() throws javax.xml.rpc.ServiceException {
    ...
    public com.breden.springboot.pagadores.services.QdocWebService_PortType getQdocWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.breden.springboot.pagadores.services.SoapBindingStub _stub = new com.breden.springboot.pagadores.services.SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.breden.springboot.pagadores.services.QdocWebService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.breden.springboot.pagadores.services.SoapBindingStub _stub = new com.breden.springboot.pagadores.services.SoapBindingStub(new java.net.URL(QdocWebService_address), this);
                _stub.setPortName(getQdocWebServiceWSDDServiceName());
                return _stub;
            }
        }
