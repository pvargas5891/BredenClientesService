...
public class SoapBindingStub extends org.apache.axis.client.Stub implements com.breden.springboot.pagadores.services.QdocWebService_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReferenceParameters"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReferenceParametersType"), com.breden.springboot.pagadores.addressing.ReferenceParametersType.class, true, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReplyTo"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReplyToType"), com.breden.springboot.pagadores.addressing.ReplyToType.class, true, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "SFRUTPagadores"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLSFRUTPagadoresType"), com.breden.springboot.pagadores.services.WSDLSFRUTPagadoresType.class, false, false);
        oper.addParameter(param);
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "SFRUTPagadoresResponse"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLSFRUTPagadoresResponseType"), com.breden.springboot.pagadores.services.WSDLSFRUTPagadoresResponseType.class, false, false);
        oper.addParameter(param);
    ...
    public SoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.pagadores.addressing.ReferenceParametersType.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.pagadores.addressing.ReplyToType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.pagadores.common.Temp_err_msg[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.pagadores.common.TtContext[].class;
            cachedSerClasses.add(cls);
            ...
            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", ">dsClientes");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.pagadores.services.TtClientesType[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "TtClientesType");
            qName2 = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "ttClientes");
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());

            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", ">dsResponse");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.pagadores.services.TtResponseResponseType[].class;
            cachedSerClasses.add(cls);
            ...
            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLSFRUTPagadoresResponseType");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.pagadores.services.WSDLSFRUTPagadoresResponseType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLSFRUTPagadoresType");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.pagadores.services.WSDLSFRUTPagadoresType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {action.value, to.value, messageID.value, referenceParameters, replyTo, body});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                body2.value = (com.breden.springboot.pagadores.services.WSDLSFRUTPagadoresResponseType) _output.get(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "SFRUTPagadoresResponse"));
            } catch (java.lang.Exception _exception) {
                body2.value = (com.breden.springboot.pagadores.services.WSDLSFRUTPagadoresResponseType) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "SFRUTPagadoresResponse")), com.breden.springboot.pagadores.services.WSDLSFRUTPagadoresResponseType.class);
            }
        }
