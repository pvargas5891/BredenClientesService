...
public class QdocWebServiceProxy implements com.breden.springboot.pagadores.services.QdocWebService_PortType {
  private String _endpoint = null;
  private com.breden.springboot.pagadores.services.QdocWebService_PortType qdocWebService_PortType = null;
  ...
  private void _initQdocWebServiceProxy() {
    try {
      qdocWebService_PortType = (new com.breden.springboot.pagadores.services.QdocWebService_ServiceLocator()).getQdocWebService();
  ...
  public com.breden.springboot.pagadores.services.QdocWebService_PortType getQdocWebService_PortType() {
    if (qdocWebService_PortType == null)
      _initQdocWebServiceProxy();
