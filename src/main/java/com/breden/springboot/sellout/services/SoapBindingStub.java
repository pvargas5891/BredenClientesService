...
import com.breden.springboot.sellout.holders.WSDLSFSellOutResponseTypeHolder;
 ...
 public class SoapBindingStub extends org.apache.axis.client.Stub implements QdocWebService_PortType {
     ...
     private static void _initOperationDesc1(){
         ...
         oper.addParameter(param);
         param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReferenceParameters"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReferenceParametersType"), ReferenceParametersType.class, true, false);
         oper.addParameter(param);
         param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReplyTo"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReplyToType"), ReplyToType.class, true, false);
         oper.addParameter(param);
         param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "SFSellOut"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLSFSellOutType"), WSDLSFSellOutType.class, false, false);
         oper.addParameter(param);
         ...
         oper.addParameter(param);
         param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "SFSellOutResponse"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLSFSellOutResponseType"), WSDLSFSellOutResponseType.class, false, false);
         oper.addParameter(param);
     ...
     public SoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         ...
         ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
             ...
             cachedSerQNames.add(qName);
             cls = TtSellOutType[].class;
             cachedSerClasses.add(cls);
             qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "TtSellOutType");
             qName2 = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "ttSellOut");
             cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
             cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());
 
             qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", ">dsResponse");
             cachedSerQNames.add(qName);
             cls = TtResponse[].class;
             cachedSerClasses.add(cls);
             qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "TtResponse");
             ...
             qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "TtSellOutDType");
             cachedSerQNames.add(qName);
             cls = TtSellOutDType.class;
             cachedSerClasses.add(cls);
             cachedSerFactories.add(beansf);
             cachedDeserFactories.add(beandf);
             ...
             qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLSFSellOutResponseType");
             cachedSerQNames.add(qName);
             cls = WSDLSFSellOutResponseType.class;
             cachedSerClasses.add(cls);
             cachedSerFactories.add(beansf);
             cachedDeserFactories.add(beandf);
 
             qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLSFSellOutType");
             cachedSerQNames.add(qName);
             cls = WSDLSFSellOutType.class;
             cachedSerClasses.add(cls);
             cachedSerFactories.add(beansf);
             cachedDeserFactories.add(beandf);
  ...
  try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {action.value, to.value, messageID.value, referenceParameters, replyTo, body});
         ...
         if (_resp instanceof java.rmi.RemoteException) {
             ...
             try {
                 body2.value = (WSDLSFSellOutResponseType) _output.get(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "SFSellOutResponse"));
             } catch (java.lang.Exception _exception) {
                 body2.value = (WSDLSFSellOutResponseType) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "SFSellOutResponse")), WSDLSFSellOutResponseType.class);
             }
         }
