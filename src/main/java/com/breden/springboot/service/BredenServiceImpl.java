...
import com.breden.springboot.customer.schemas.Temp_err_msg;
import com.breden.springboot.customer.schemas.TtContext;
import com.breden.springboot.customer.webservices.CustomerResponseType;
import com.breden.springboot.customer.webservices.CustomerType;
import com.breden.springboot.customer.webservices.QdocWebServiceProxy;
import com.breden.springboot.customer.webservices.QdocWebService_PortType;
import com.breden.springboot.customer.webservices.WSDLMaintainCustomerResponseType;
...
@Service("bredenService")
public class BredenServiceImpl implements BredenService {
	...
	public ResponseDTO<String,List<CustomerResponseType>> generaClienteSalesForce(ClienteV1 cliente) {
		...
		ResponseDTO<String,List<CustomerResponseType>> responseDto = new ResponseDTO<String,List<CustomerResponseType>>();
		...
		try {
    		...
    		WSDLMaintainCustomerType body = new WSDLMaintainCustomerType();
    		...
    		ttContext.setPropertyValue(prop.getProperty("qad.service.context.value"));
    		...
    		customerType.setAdPhone(cliente.getTelefono());
    		...
    		customerType.setCmCrHold(false);
    		...
    		customerType.setCmSlspsn1(usuarios);
    		...
    		WSDLMaintainCustomerResponseTypeHolder body2 = new WSDLMaintainCustomerResponseTypeHolder(); 		
			...
			String mensaje="";
			List<CustomerResponseType> result = new ArrayList<CustomerResponseType>();
			if(body2.value.getResult().equals("error")) {
				...
				WSDLMaintainCustomerResponseType reponse= body2.value;
				CustomerResponseType[] resultado = reponse.getDsCustomerResponse();
				if(resultado != null) {
					for(CustomerResponseType producto: resultado) {
						result.add(producto);
					}
				}
			...
			utils.sendLogTransaccion(responseDto.toString(), "Creacion Cliente", prop.getProperty("qad.service.address"), cliente.toStringJSON());
