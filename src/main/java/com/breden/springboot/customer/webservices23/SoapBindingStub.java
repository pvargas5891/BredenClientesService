...
public class SoapBindingStub extends org.apache.axis.client.Stub implements com.breden.springboot.customer.webservices23.QdocWebService_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReferenceParameters"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReferenceParametersType"), com.breden.springboot.customer.addressing23.ReferenceParametersType.class, true, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReplyTo"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "ReplyToType"), com.breden.springboot.customer.addressing23.ReplyToType.class, true, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "maintainCustomerSF"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLMaintainCustomerSFType"), com.breden.springboot.customer.webservices23.WSDLMaintainCustomerSFType.class, false, false);
        oper.addParameter(param);
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "maintainCustomerSFResponse"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLMaintainCustomerSFResponseType"), com.breden.springboot.customer.webservices23.WSDLMaintainCustomerSFResponseType.class, false, false);
        oper.addParameter(param);
    ...
    public SoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.customer.addressing23.ReferenceParametersType.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.customer.addressing23.ReplyToType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.customer.schemas23.Temp_err_msg[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.customer.schemas23.TtContext[].class;
            cachedSerClasses.add(cls);
            ...
            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", ">dsCustomer");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.customer.webservices23.CustomerType[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "CustomerType");
            qName2 = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "customer");
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());

            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", ">dsResponse");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.customer.webservices23.TtResponseResponseType[].class;
            cachedSerClasses.add(cls);
            ...
            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLMaintainCustomerSFResponseType");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.customer.webservices23.WSDLMaintainCustomerSFResponseType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "WSDLMaintainCustomerSFType");
            cachedSerQNames.add(qName);
            cls = com.breden.springboot.customer.webservices23.WSDLMaintainCustomerSFType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {action.value, to.value, messageID.value, referenceParameters, replyTo, body});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                body2.value = (com.breden.springboot.customer.webservices23.WSDLMaintainCustomerSFResponseType) _output.get(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "maintainCustomerSFResponse"));
            } catch (java.lang.Exception _exception) {
                body2.value = (com.breden.springboot.customer.webservices23.WSDLMaintainCustomerSFResponseType) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("urn:schemas-qad-com:xml-services", "maintainCustomerSFResponse")), com.breden.springboot.customer.webservices23.WSDLMaintainCustomerSFResponseType.class);
            }
        }
